...
Function* find_default_function(const char* name)
{
	...
	static Function* list[] = { &logical_or_fun, &logical_and_fun, &min_fun, &max_fun, &abs_fun,
		&not_fun, &sign_fun, &sqrt_fun, &sin_fun, &cos_fun, &tan_fun, &asin_fun, &acos_fun, &atan_fun,
		&atan2_fun, &bitxor_fun, &_if, NULL };
